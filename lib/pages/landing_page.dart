  ...
  void _checkAuthStatus() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (authService.currentUser != null) {
        debugPrint(
            '🔍 LandingPage - User detected: ${authService.currentUser?.email}');
        ...
        debugPrint(
            '🔍 LandingPage - Admin authenticated: ${adminAuthService.isAdminAuthenticated}');
        debugPrint(
            '🔍 LandingPage - Current admin: ${adminAuthService.currentAdmin?.email ?? 'null'}');

        if (adminAuthService.isAdminAuthenticated) {
          debugPrint(
              '✅ LandingPage - Admin logged in, redirecting to admin dashboard...');
          _hasRedirected = true;
          Navigator.pushReplacementNamed(context, '/admin/dashboard');
        } else {
          debugPrint(
              '🔄 LandingPage - Regular user logged in, redirecting to welcome...');
          _hasRedirected = true;
            ...
            Container(
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final isVerySmall =
                      screenWidth < 400; // Changed from <= 360 to < 400
                              ...
                              Material(
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      border: Border.all(
                                          color: AppTheme.goldColor, width: 1),
                                      borderRadius: BorderRadius.circular(6),
                                    ),
                                    child: const Center(
                                      child: Text(
